 ...
 */
public class ExoPlayerJDJ implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
    ...
    public interface RendererBuilder {
         ...
         *
         * @param player The player for which renderers are being built. {@link ExoPlayerJDJ#onRenderers}
         *     should be invoked once the renderers have been built. If building fails,
         *     {@link ExoPlayerJDJ#onRenderersError} should be invoked.
         */
        void buildRenderers(ExoPlayerJDJ player);
        /**
         * Cancels the current build operation, if there is one. Else does nothing.
         * <p>
         * A canceled build operation must not invoke {@link ExoPlayerJDJ#onRenderers} or
         * {@link ExoPlayerJDJ#onRenderersError} on the player, which may have been released.
         */
        void cancel();
    }
    ...
    public ExoPlayerJDJ(RendererBuilder rendererBuilder) {
     ...
     *
     * @param trackNames The names of the available tracks, indexed by {@link ExoPlayerJDJ} TYPE_*
     ...
     *     indexed by {@link ExoPlayerJDJ} TYPE_* constants. May be null if there are no types with
     *     multiple tracks. An individual element may be null if it does not have multiple tracks.
     * @param renderers Renderers indexed by {@link ExoPlayerJDJ} TYPE_* constants. An individual
